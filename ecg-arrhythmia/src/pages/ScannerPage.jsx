...
import { Activity, Loader2, RotateCcw, Database, Hash } from 'lucide-react';
import FileUpload from '../components/FileUpload';
import ResultCard from '../components/ResultCard';
import { predictFromCSV, getSampleData, predictFromSignal } from '../services/api';
...
export default function ScannerPage({ onAnalysisComplete }) {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            const data = await predictFromCSV(file, row);
            setResult(data);
            setStep('result');
        ...
        <div className="scanner-page">
            ...
            <div className="container">
                ...
                <div className="scanner-header animate-fade-in">
                    ...
                    <h1>ECG <span className="text-gradient">Scanner</span></h1>
