...
export default function ResultCard({ result }) {
    ...
    const handleDownloadReport = async () => {
        try {
            ...
            doc.text("HeartAlert AI Analysis Report", 15, 25);
            ...
            doc.text("DISCLAIMER: This report is generated by AI (HeartAlert AI) for educational purposes only.", 15, pageHeight - 15);
            doc.text("Consult a healthcare professional for medical diagnosis.", 15, pageHeight - 10);

            doc.save(`heartalert_report_${Date.now()}.pdf`);
