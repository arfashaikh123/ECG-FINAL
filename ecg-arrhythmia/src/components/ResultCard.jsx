...
export default function ResultCard({ result }) {
    ...
    const handleDownloadReport = async () => {
        try {
            ...
            doc.text("CardioScan Analysis Report", 15, 25);
            ...
            doc.text("DISCLAIMER: This report is generated by AI (CardioScan) for educational purposes only.", 15, pageHeight - 15);
            doc.text("Consult a healthcare professional for medical diagnosis.", 15, pageHeight - 10);

            doc.save(`cardioscan_report_${Date.now()}.pdf`);
